...
new class extends Component
{
    ...
    public function destroy(){
        $instrumento = instrumento::findOrFail($this->id);
        ...
        if ($instrumento){
            try{
                ...
                if ($e->getCode() == 23503)
                    Flux::toast(variant : "danger", heading: 'Não é possível remover este registro...', text : "Existem Avaliações vinculadas a este Instrumento. Caso deseje remove-lo, por favor desvincule as avaliações primeiro.");
                else
...
<flux:modal name="remove">
    <div class="flex items-center gap-2">
        <flux:heading size="lg">Remover Instrumento</flux:heading>
    </div>
    <flux:text class="mt-2">Tem certeza que deseja remover este Instrumento?</flux:text>
